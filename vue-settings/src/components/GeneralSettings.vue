<template>
    <div>
        ...
        <div>
            <label class="mb-1.5">Username</label>
        ...
        <div>
            <label class="mb-1.5">About Me</label>
            <textarea v-model="general.about"></textarea>
        </div>
        <div>
            <label class="mb-1.5">Gender</label>
            <label>
        ...
        <div>
            <label class="mb-1.5">Country</label>
...
const save = () => {
    addNotification(`General Settings has been saved.`);
}
</script>